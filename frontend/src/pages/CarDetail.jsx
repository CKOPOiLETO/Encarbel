  ...
  if (loading || !car) return (
    ...
    return (
      <div className="max-w-7xl mx-auto px-4 pb-20">
        ...
        <button 
          onClick={() => navigate(-1)} 
          className="inline-flex items-center gap-2 text-gray-500 hover:text-blue-600 mb-6 font-medium transition-colors cursor-pointer"
        >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          <div className="lg:col-span-8 space-y-8">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4">
              ...
              {/* Список миниатюр с кастомным скроллбаром */}
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-y-8 gap-x-10">
                ...
                <div className="border-b pb-2"><span className="text-gray-400 block text-[10px] uppercase tracking-widest mb-1 font-bold">Объем двигателя</span> <span className="font-bold text-lg">{car.displacement_cc ? `${car.displacement_cc} см³` : '-'}</span></div>
          ...
          <div className="lg:col-span-4">
            {car.is_lease ? (
              ...
              <div className="bg-white rounded-2xl shadow-2xl border border-blue-50 p-6 sticky top-24 max-h-[calc(100vh-6rem)] overflow-y-auto custom-scrollbar">
                ...
                {/* Настройки калькулятора внутри сметы */}
